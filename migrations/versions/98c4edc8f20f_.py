...
def upgrade():
    ...
    op.add_column('students', sa.Column('student_full_name', sa.String(150)))
    op.add_column('staff', sa.Column('staff_full_name', sa.String(150)))
    op.rename_table('classroom_school_years','classroom_schoolyears')
    op.drop_column('users', sa.Column('token'))
    op.drop_column('users', sa.Column('date_created'))
